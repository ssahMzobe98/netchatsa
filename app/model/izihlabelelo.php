		                ...
		                <div class="welcome-text">
		                  ...
		                  <div class="welcome-btn-groupt" style="">
		                      ...
		                      if(isset($_GET['music'])){
		                          ...
		                          $_display=$pdo->getMusicType($type_of_music);
		                          if(count($_display)==0){
		                              ?>
		                             ...
		                             foreach($_display as $row){
		                                  $recording_label=$pdo->getRecordingLabel($row['recording_label']);
		                                  $album="";
		                                 $album_info="";
		                                  if($row['album']<1){
		                                      ...
		                                      $album_info=$pdo->getAlbuminfo($row['album']);
		                                      $album=$album_info['album_name'];
		                                  }
		                                  $artist_info=$pdo->getArtistInfo($row['artist']);
		                      ...
		                      elseif(isset($_GET['recording_label'])){
		                          $_display=$pdo->getTrackOfThisRecordingLabel($_GET['recording_label']);
		                          if(count($_display)==0){
		                              ?>
		                              <h5 style="color:red;">No Music Loaded</h5>
		                              <?php
                              ...
                              elseif(isset($_GET['album'])){
                                  $_display=$pdo->getTrackMusicOfTRhisAlbum($_GET['album']);
		                          if(count($_display)==0){
		                              ?>
		                              <h5 style="color:red;">No Music Loaded</h5>
		                              <?php
		                      ...
		                      elseif(isset($_GET['latest_release'])){
		                          $_display=$pdo->getTracksMusic("time_uploaded");
		                          if(count($_display)==0){
		                              ?>
		                              <h5 style="color:red;">No Music Loaded</h5>
		                              <?php
		                      ...
		                      elseif(isset($_GET['artist'])){
		                          $_display=$pdo->getTracksMusicArtist($_GET['artist']);
		                          if(count($_display)==0){
		                              ?>
		                              <h5 style="color:red;">No Music Loaded</h5>
		                              <?php
		                          ...
		                          $_display=$pdo->getTracksMusic("downloads");
		                          if(count($_display)==0){
		                              ?>
		                              <h5 style="color:red;">No Music Loaded</h5>
		                              <?php
