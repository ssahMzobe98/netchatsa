...
downloadApp.addEventListener("click", (e) => {
  ...
  aElement.setAttribute("download", "Netchatsa");
  aElement.setAttribute("href", "https://play.google.com/store/apps/details?id=com.mmshightech.netchatsa&hl=en_ZA&gl=US");
  aElement.click();
});
