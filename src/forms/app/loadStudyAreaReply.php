...
if(isset($_SESSION['usermail'])){
        ...
        if(isset($_GET['_'])&&isset($_GET['min'])&&isset($_GET['max'])){
            ...
            $response=$studyArea->getPostOfThisUid($_GET['_']);
            if(count($response)!=1){
                ...
                <div class="package">
                    ...
                    <div class="displayEmogies flex" >
                        ...
                        <i class="fa fa-reply" aria-hidden="true"></i><small><?php echo $studyArea->getNumOfReply($post_id);?></small>
                        </div>
                        <!--<div class="like flex" data-toggle="modal" data-target="#replyStudyArea">-->
                        <!--<i class="fa fa-ban" aria-hidden="true"></i><small><?php echo $studyArea->getNumOfReply($post_id);?></small>-->
                        <!--</div>-->
                        <!--<div class="like flex" data-toggle="modal" data-target="#replyStudyArea">-->
                        <!--<i class="fa fa-flag" aria-hidden="true"></i><small><?php echo $studyArea->getNumOfReply($post_id);?></small>-->
                        <!--</div>-->
        ...
        <script>
            $(document).ready(function(){
                ...
                $(".studyAreaCodeReplyModal").click(function(){
                    ...
                    // $("#showAnswersModal").modal("show");
                     $.ajax({
                        url:"../src/forms/app/studyAreaCodeReplyModal.php",
                        type:"POST",
                ...
                $(".studyAreaTextImgReplyModal").click(function(){
                    ...
                    // $("#showAnswersModal").modal("show");
                     $.ajax({
                        url:"../src/forms/app/studyAreaTextImgReplyModal.php",
                        type:"POST",
                        data:{post_id_Code_reply_modal:post_id_Code_reply_modal},
                        cache:false,
                        beforeSend:function(){
            ...
            function loadStudyAreaRepliesForSet(post_id,limit, start){
              ...
              $.ajax({
               url:"../src/forms/app/studyAreaRepliesLoader.php",
               method:"POST",
